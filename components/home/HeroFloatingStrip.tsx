 ...
 */
const cellClass = cx(
  "flex w-full min-w-0 flex-col items-center gap-1 px-1.5 py-1 text-center sm:gap-3 sm:px-4 sm:py-3.5 lg:gap-3 lg:px-4 lg:py-4",
...
const iconBoxClass = "relative h-8 w-8 shrink-0 sm:h-12 sm:w-12";
